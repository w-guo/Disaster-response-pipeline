...
def load_data(messages_filepath, categories_filepath):
    ...
    Returns:
    df: the merged dataframe from two csv files
    """
    # read in file
...
def clean_data(df):
    ...
    Args: 
    df: raw dataframe merged from 'messages' and `categories` dataframes
    ...
    # check category column values to make sure they only consist of 0 and 1
    for column in category_colnames:
...
def save_data(df, database_filename):
    ...
    database_filename: file name of the database
    """
